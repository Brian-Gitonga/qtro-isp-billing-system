...
<div class="row">
	...
	<div class="col-12">
		<div style="padding-bottom: 5px; padding-top: 5px;">
		  ...
		  <button class="btn bg-primary" onclick="exportTableToCSV('report-qtro-isp-<?= $filedownload . $fprefix; ?>.csv')" title="Download selling report"><i class="fa fa-download"></i> CSV</button>
		  ...
		  <button  id="remSelected" style="display: none;" class="btn bg-red" onclick="QtroISPRemoveReportSelected()"><i class="fa fa-trash"></i> <span id="selected"></span> <?= $_selected ?></button>
		</div>
	</div>
	</div>
