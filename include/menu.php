...
<div id="navbar" class="navbar">
  <div class="navbar-left">
    <a id="brand" class="text-center" href="javascript:void(0)">Qtro ISP</a>
...
?>  
  <div class="menu text-center align-middle card-header" style="border-radius:0;"><h3 id="QtroISPSession"><?= $session; ?></h3></div>
  <a class="connect menu <?= $shome; ?>" id="<?= $session; ?>&c=settings"><i class='fa fa-tachometer'></i> <?= $_dashboard ?></a>
  <a  href="./admin.php?id=settings&session=<?= $session; ?>" class="menu <?= $ssettings; ?>" title="Qtro ISP Settings"><i class='fa fa-gear'></i> <?= $_session_settings ?></a>
...
<div id="navbar" class="navbar">
  <div class="navbar-left">
    <a id="brand" class="text-center" href="./?session=<?= $session; ?>">Qtro ISP</a>
...
<a id="cpage" class="navbar-left" href="javascript:void(0)"><?= $mpage; ?></a>
 ...
 <div class="navbar-right">
  ...
  <select class="connect optfa ses text-right mr-t-10 pd-5">
    <option id="QtroISPSession" value="<?= $session; ?>"><?= $hotspotname; ?></option>
      <?php
